...
public class OslpElsterResponseAnswer implements Answer<ChannelFuture> {

    private final OslpChannelHandler oslpChannelHandler;
    private final OslpEnvelope oslpResponse;
    private final Channel channel;

    public OslpElsterResponseAnswer(final OslpChannelHandler oslpChannelHandler, final OslpEnvelope oslpResponse,
