...
import com.alliander.osgp.adapter.protocol.oslp.elster.infra.networking.OslpChannelHandler;
...
import com.alliander.osgp.adapter.protocol.oslp.elster.infra.networking.OslpDeviceService;
import com.alliander.osgp.adapter.protocol.oslp.elster.infra.networking.SequenceNumberUtils;
import com.alliander.osgp.oslp.OslpEnvelope;
import com.alliander.osgp.shared.security.CertificateHelper;

public class OslpElsterTestUtils {
    ...
    public static OslpChannelHandlerClient createOslpChannelHandlerWithResponse(final OslpEnvelope response,
        ...
        final OslpChannelHandlerClient oslpChannelHandler = OslpElsterTestUtils.createOslpChannelHandlerClient();
        ...
        when(channel.write(anyObject()))
                .thenAnswer(new OslpElsterResponseAnswer(oslpChannelHandler, response, channel));
    ...
    public static void onMessageReceivedWrapper(final OslpEnvelope message, final OslpChannelHandler channelHandler,
        ...
        message.validate(OslpElsterTestUtils.getDefaultPublicKey());
